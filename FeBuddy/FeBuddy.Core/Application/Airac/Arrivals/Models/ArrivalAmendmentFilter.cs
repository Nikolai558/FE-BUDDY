...
/// </summary>
public enum ArrivalAmendmentFilter
{
	...
	/// <see cref="ArrivalSettings.AmendedWithinCycles"/> cycles, counting the cycle the data came
	/// from as the first. Cycles are counted back from each procedure's own cycle date in 28-day
	/// steps.
	/// </summary>
	Cycles = 1,
	...
	/// <see cref="ArrivalSettings.AmendedWithinDays"/> days, where today is the local date of the
	/// run.
	/// </summary>
	Days = 2,
	...
	/// <see cref="ArrivalSettings.AmendedOnOrAfter"/>.
	/// </summary>
	Date = 3,
}
