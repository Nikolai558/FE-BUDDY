...
/// <summary>
/// One levelled message a service emits while running. The level survives all the way to the
/// GUI's run panel and the Dashboard activity log, so a run reporting 483 routine buffer notices
/// reads as clean rather than as a wall of amber.
/// </summary>
