...
public class Location
{
    ...
    public Location(string Lat, string Lon)
    {
        ...
        bool isValid = GeoMath.IsValidDMS(Lat, Lon);
        if (isValid)
        {
    ...
    {
        bool isValid = GeoMath.IsValidDecimal(Lat, Lon);
        if (isValid)
        {
            // Possible Optimization - Do we really need BOTH DMS and DEC at Location Creation Time?
            DecLat = Lat;
    ...
    {
        dmsLat = value;
        decLat = (double)GeoMath.ToDecimal(value);
    }
    ...
    {
        dmsLon = value;
        decLon = (double)GeoMath.ToDecimal(value);
    }
    ...
    {
        decLat = value;
        dmsLat = GeoMath.ToDMS(value, true);
    }
    ...
    {
        decLon = value;
        dmsLon = GeoMath.ToDMS(value, false);
    }
