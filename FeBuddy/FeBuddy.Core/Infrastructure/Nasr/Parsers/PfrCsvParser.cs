...
namespace FeBuddy.Core.Infrastructure.Nasr.Parsers
{
    public class PfrCsvParser
    {
        public PfrCsvDataCollection ParsePfrBase(string filePath)
        {
            ...
            result.PfrBase = NasrCsvReader.ProcessLines(
                filePath,
                fields => new PfrBase
                {
                    ...
                    RouteNo = NasrCsvReader.ParseInt(fields["ROUTE_NO"]),
        ...
        public PfrCsvDataCollection ParsePfrRmtFmt(string filePath)
        {
            ...
            result.PfrRmtFmt = NasrCsvReader.ProcessLines(
                filePath,
                fields => new PfrRmtFmt
                {
                    ...
                    Seq = NasrCsvReader.ParseInt(fields["Seq"]),
                    Dcntr = fields["DCNTR"],
                    Acntr = fields["ACNTR"],
                });
        ...
        public PfrCsvDataCollection ParsePfrSeg(string filePath)
        {
            ...
            result.PfrSeg = NasrCsvReader.ProcessLines(
                filePath,
                fields => new PfrSeg
                {
                    EffDate = fields["EFF_DATE"],
                    ...
                    PfrTypeCode = fields["PFR_TYPE_CODE"],
                    RouteNo = NasrCsvReader.ParseInt(fields["ROUTE_NO"]),
                    SegmentSeq = NasrCsvReader.ParseInt(fields["SEGMENT_SEQ"]),
