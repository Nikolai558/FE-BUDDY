...
/// </remarks>
public static class AirportGeojsonService
{
	...
	private static object? ValueFor(Airport airport, AirportFebProperty property) => property switch
	{
		...
		AirportFebProperty.Lat => airport.Latitude,
		AirportFebProperty.Lon => airport.Longitude,
	...
	private static string Name(AirportFebProperty property) => property switch
	{
		...
		AirportFebProperty.Lat => "lat",
		AirportFebProperty.Lon => "lon",
