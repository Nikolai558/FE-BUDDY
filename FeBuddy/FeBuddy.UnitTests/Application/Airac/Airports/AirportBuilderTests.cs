...
public class AirportBuilderTests
{
	...
	{
		NasrCsvDataCollection data = AirportTestDataBuilder.Build(
			airports: new[] { AirportTestDataBuilder.Base("SEA") },
			runways: new[]
			{
	...
	public void runway_ends_are_ordered_by_end_id_regardless_of_row_order()
	{
		NasrCsvDataCollection data = AirportTestDataBuilder.Build(
			airports: new[] { AirportTestDataBuilder.Base("SEA") },
			runways: new[] { AirportTestDataBuilder.Runway("SEA", "16L/34R", 11901) },
			runwayEnds: new[]
			{
	...
	public void a_runway_with_no_end_coordinates_keeps_its_place_and_is_reported_as_info()
	{
		NasrCsvDataCollection data = AirportTestDataBuilder.Build(
			airports: new[] { AirportTestDataBuilder.Base("SEA") },
			runways: new[] { AirportTestDataBuilder.Runway("SEA", "09/27", 8000) },
			runwayEnds: new[]
			{
	...
	{
		NasrCsvDataCollection data = AirportTestDataBuilder.Build(
			airports: new[] { AirportTestDataBuilder.Base("SEA"), AirportTestDataBuilder.Base("PDX") },
			frequencies: new[]
			{
	...
	public void an_airport_with_no_matching_frequency_rows_reports_none()
	{
		NasrCsvDataCollection data = AirportTestDataBuilder.Build(
			airports: new[] { AirportTestDataBuilder.Base("SEA") },
			frequencies: new[] { AirportTestDataBuilder.Frequency("SEA", "119.900", "LCL/P") });
	...
	public void airports_come_back_ordered_by_faa_identifier()
	{
		...
		Assert.Equal(new[] { "AAA", "MMM", "ZZZ" }, result.Airports.Select(a => a.FaaId));
	}
	...
	public void the_mapped_and_joined_fields_are_carried_onto_the_built_airport()
	{
		NasrCsvDataCollection data = AirportTestDataBuilder.Build(
			...
			classAirspace: new[] { AirportTestDataBuilder.ClassAirspaceRow("SEA", classB: "Y", classE: "Y") });
