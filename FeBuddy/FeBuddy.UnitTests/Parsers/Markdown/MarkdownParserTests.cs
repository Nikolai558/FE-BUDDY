...
namespace FeBuddy.UnitTests.Parsers.Markdown;
...
public sealed class MarkdownParserTests
{
    ...
    [InlineData("")]
    [InlineData("   \n\n  ")]
    public void Parse_BlankInput_ReturnsNoBlocks(string? markdown)
    {
        Assert.Empty(MarkdownParser.Parse(markdown));
    }

    [Fact]
    public void Parse_Headings_ReadLevelAndStripClosingHashes()
    {
    ...
    [Fact]
    public void Parse_ParagraphLines_JoinSoftBreaksAndKeepHardBreaks()
    {
        var blocks = MarkdownParser.Parse("one\n  two  \nthree\\\nfour\n\nnext");
    ...
    [Fact]
    public void Parse_CrLfAndTabs_AreNormalised()
    {
    ...
    [Fact]
    public void Parse_HtmlComments_AreDropped()
    {
    ...
    [Fact]
    public void Parse_FencedCode_IsVerbatimAndDedented()
    {
    ...
    [Fact]
    public void Parse_Quote_CollectsMarkedAndLazyLines()
    {
    ...
    [Fact]
    public void Parse_QuoteEndsAtBlankLine()
    {
    ...
    [Fact]
    public void Parse_BulletList_WithNestingAndContinuation()
    {
    ...
    [Fact]
    public void Parse_LooseList_BlankLinesBetweenItemsKeepOneList()
    {
        var blocks = MarkdownParser.Parse("- a\n\n- b\n\n  more of b\n\n\nafter");
    ...
    [Fact]
    public void Parse_List_EndsAtHeadingOrBlankThenText()
    {
        var blocks = MarkdownParser.Parse("- a\n# Heading\n- b\n\ntext");
    ...
    [Fact]
    public void Parse_List_ShallowNestedMarkerStillNests()
    {
    ...
    [Fact]
    public void Parse_List_EmptyItemAndWideGap()
    {
        var blocks = MarkdownParser.Parse("-\n-      code-ish");
    ...
    [Fact]
    public void Parse_TheV290ReleaseNotesShape()
    {
        const string markdown = """
    ...
    [Fact]
    public void ParseInlines_Null_Throws()
    {
        Assert.Throws<ArgumentNullException>(() => MarkdownParser.ParseInlines(null!));
    }

    [Fact]
    public void ParseInlines_Emphasis()
    {
    ...
    [Fact]
    public void ParseInlines_NestedEmphasis()
    {
    ...
    [InlineData("_a_b")]
    [InlineData("**")]
    public void ParseInlines_NonEmphasis_StaysLiteral(string text)
    {
    ...
    [Fact]
    public void ParseInlines_UnderscoreClosesAtEndOfText()
    {
        Assert.Equal([new MarkdownSpan("x", MarkdownStyle.Italic)], MarkdownParser.ParseInlines("_x_"));
    }

    [Fact]
    public void ParseInlines_EmphasisSkipsEscapesAndCode()
    {
        var spans = MarkdownParser.ParseInlines("*a \\* `b*` c*");
    ...
    public void ParseInlines_UnsafeOrRelativeLinks_AreUnlinked(string text)
    {
    ...
    [InlineData("[x] (gap)")]
    [InlineData("[x]")]
    public void ParseInlines_BrokenLinks_StayLiteral(string text)
    {
        Assert.Equal([new MarkdownSpan(text)], MarkdownParser.ParseInlines(text));
    }

    [Fact]
    public void ParseInlines_Autolink()
    {
        Assert.Equal(
    ...
    [Fact]
    public void ParseInlines_BareUrls_TrimSentencePunctuation()
    {
    ...
    [Fact]
    public void ParseInlines_BareUrl_NeedsAWordBoundary()
    {
        Assert.Equal([new MarkdownSpan("xhttps://x.test")], MarkdownParser.ParseInlines("xhttps://x.test"));
    }

    [Fact]
    public void ParseInlines_BareUrlInsideALink_IsNotRelinked()
    {
        Assert.Equal(
    ...
    [Fact]
    public void ParseInlines_IssueReferences()
    {
    ...
    [Fact]
    public void ParseInlines_IssueReferences_OffWithoutABase()
    {
