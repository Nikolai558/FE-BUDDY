...
/// </summary>
public sealed class AirwayGeojsonServiceDesignationTests : IDisposable
{
	...
	public void designation_run_names_files_from_the_awy_id_not_awy_designation()
	{
		...
		AirwayGeojsonGenerateResult result = AirwayGeojsonService.Generate(built.Airways, settings);
