...
/// <summary>
/// Covers <see cref="EfficientLinestringHandler"/> directly and through
/// <see cref="DepartureGeometryBuilder"/> on the real DOTSS2 procedure.
/// </summary>
public class EfficientLinestringHandlerTests
{
	...
	{
		IReadOnlyList<LineString> lines = EfficientLinestringHandler.Build(
