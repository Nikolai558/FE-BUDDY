...
/// </summary>
public sealed class SubServiceSelection : ObservableObject
{
    private readonly Action _onChanged;
    private bool _isSelected;

    /// <summary>Creates a picker row.</summary>
    ...
    public SubServiceSelection(SubServiceDescriptor descriptor, bool isSelected, Action onChanged)
    {
    ...
    public SubServiceDescriptor Descriptor { get; }
