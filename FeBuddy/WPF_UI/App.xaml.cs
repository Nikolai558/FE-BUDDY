...
using WPF_UI.Core.Contracts.Services;
using WPF_UI.Core.Services;
using WPF_UI.Models;
...
public partial class App : Application
{
    ...
    private void ConfigureServices(HostBuilderContext context, IServiceCollection services)
    {
        ...
        services.AddTransient<AiracUpdatePage>();

        services.AddTransient<RWRadarVideoMapConversionViewModel>();
        services.AddTransient<RWRadarVideoMapConversionPage>();

        services.AddTransient<Sct2FileConversionViewModel>();
        services.AddTransient<Sct2FileConversionPage>();
