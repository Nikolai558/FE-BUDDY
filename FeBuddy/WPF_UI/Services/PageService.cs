...
public class PageService : IPageService
{
    ...
    public PageService(IServiceProvider serviceProvider)
    {
        ...
        Configure<AiracUpdateViewModel, AiracUpdatePage>();
        Configure<RWRadarVideoMapConversionViewModel, RWRadarVideoMapConversionPage>();
        Configure<Sct2FileConversionViewModel, Sct2FileConversionPage>();
